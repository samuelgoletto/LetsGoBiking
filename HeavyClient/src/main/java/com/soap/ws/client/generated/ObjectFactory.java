...
public class ObjectFactory {
    ...
    private final static QName _GetItinaryOrigin_QNAME = new QName("http://tempuri.org/", "origin");
    ...
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "origin", scope = GetItinary.class)
    public JAXBElement<String> createGetItinaryOrigin(String value) {
        return new JAXBElement<String>(_GetItinaryOrigin_QNAME, String.class, GetItinary.class, value);
    }
    ...
    public JAXBElement<String> createGetItinaryResponseGetItinaryResult(String value) {
        return new JAXBElement<String>(_GetItinaryResponseGetItinaryResult_QNAME, String.class, GetItinaryResponse.class, value);
    }
